    ...
    <main className="grid min-h-[100dvh] grid-cols-1 bg-[#fafafa] lg:grid-cols-[minmax(0,1fr)_480px]">
      <section className="hidden border-r bg-white px-12 py-10 lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="max-w-xl pb-8">
          ...
          <h1 className="max-w-lg text-4xl font-semibold tracking-[-0.045em] text-balance">每个用户都有独立的 OpenCode Go 账号池。</h1>
...
export function Brand() {
  return <div className="flex items-center gap-2.5" aria-label="OpenCode Go Console"><span className="grid size-7 place-items-center rounded-md bg-[#171717] text-[11px] font-semibold text-white">O</span><span className="text-sm font-semibold tracking-[-0.025em]">OpenCode Go Console</span></div>;
}
